  ...
  return (
    <footer>
      ...
      <div className="grid-cont">
        ...
        <div className="add">
          <p>{dictionary.create}</p>
          <Link href={`/${lang}/createService`}>{dictionary.services}</Link>
          <Link href={`/${lang}/createTask`}>{dictionary.tasks}</Link>
        </div>
        <div className="register">
          <p>{dictionary.register}</p>
          <Link href={`/${lang}/sign-in`}>{dictionary.login}</Link>
          <Link href={`/${lang}/sign-up`}>{dictionary.signUp}</Link>
        </div>
        <div className="contact-form">
          <p>{dictionary.contactUs}</p>
          <ContactForm email={mail} dictionary={dictionary} lang={lang} />
        </div>
      </div>
    </footer>
  );
